...
if (window.top === window.self) {
    // Styling
    GM_addStyle(".TFH_score{position:absolute;left:0;top:0;z-index:10;padding:50px 1em 1em 1em;width:3em;text-align:center}.TFH_Bubble{box-sizing:border-box;padding:.65em .5em;width:2.5em;height:2.5em;margin:.5em;border-radius:50%;box-shadow:0 0 10px white;text-align:center}.TFH_I{padding:.25em .5em}.TFH_NN, TFH_NN a{background-color:#b00;color:white}.TFH_N, TFH_N a{background-color:#c66;color:white}.TFH_O, TFH_O a{background-color:#bbb;color:#444}.TFH_P,TFH_P a{background-color:#cc6;color:white}.TFH_PP,TFH_PP a{background-color:#bb0;color:white}");
    var Months = [];
        Months["Jan"]=0;Months["Feb"]=1;Months["Mar"]=2;Months["Apr"]=3;Months["May"]=4;Months["Jun"]=5;Months["Jul"]=6;Months["Aug"]=7;Months["Sep"]=8;Months["Oct"]=9;Months["Nov"]=10;Months["Dec"]=11;
...
console.log(You);
                ...
                if ($('.FollowStatus').length != 0) {
                    ...
                    $('.ProfileHeaderCard-screenname').append('<span class="FollowStatus TFH_I TFH_N">ne vous suit pas</span>');
...
//!todo choose values for pastille
                var pastille = "TFH_O";
                tfhBubble(pastille, "convergence : " + User["fwfg"], User["fwfg"]);
...
//                console.log(You);
                ...
                var insc = new Date(Insc[5],Months[Insc[1]],Insc[2]),
                    today = new Date();
                var elapsed = (today - insc)/360000/24,
                    tweets = User.statuses_count;
                var fc = tweets / elapsed;
                User["fc"] = fc;
                tfhBubble(pastille, "followcost : " + fc, fc);
